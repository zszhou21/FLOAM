...
from models.Update import LocalUpdateNTD
...
if __name__ == '__main__':
    ...
    #base_dir = '/root/fedntd_results/'
    algo_dir = 'fedntd'
    save_folder = './results/fedntd'
    ...
    for iter in range(args.epochs):
        ...
        for idx in idxs_users:
            #数据集名字，序号
            local = LocalUpdateNTD(args=args, dataset=dataset_path, idxs=idx, task = task)
